...
const Login = () => {
  ...
  return (
    <div className={Style.container}>
        <form>
            <input type="email" className='sign-in-inp' name="email" id="email" placeholder='Enter Email' onChange={(e)=> onChangeHandler(e.target , signInData , setSignInData)}/>
            <input type="password" className='sign-in-inp' name="password" id="password" placeholder='Enter Password' onChange={(e)=> onChangeHandler(e.target , signInData , setSignInData)} />
